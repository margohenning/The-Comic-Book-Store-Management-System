...
INSERT INTO `book` VALUES (1,5,5,'The Flash','123456789',120.80,'Available'),(2,6,6,'Superman','098765432',130.70,'Available');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comic`.`book_BEFORE_INSERT` BEFORE INSERT ON `book` FOR EACH ROW
BEGIN
IF (NEW.status ="") THEN
